.. UppASD-AiiDA documentation master file, created by
   sphinx-quickstart on Mon Apr 26 16:10:44 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

.. figure:: _log/logo.png
    :width: 600px
    :align: left



UppASD-AiiDA's documentation
========================================
...
.. highlights:: Olle Eriksson, Anders Bergman, Lars Bergqvist, and Johan Hellsvik, 
   Atomistic Spin Dynamics: Foundations and Applications Oxford University Press 2017
   https://global.oup.com/academic/product/atomistic-spin-dynamics-9780198788669?cc=se&lang=en&
