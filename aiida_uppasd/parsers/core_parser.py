...
class UppASDBaseParser(Parser):
    ...
    def parse(self, **kwargs):  # pylint: disable=too-many-locals, too-many-statements, too-many-branches
        ...
        with out_folder.open('_scheduler-stdout.txt', 'r') as handler:
        ...
        for filename in list_of_files:
            ...
            if 'coord' in filename:
                ...
                ### print(out_folder)
                ### print('::::::::::::::::::::::::::::::::::::')
                ### print('Type for out_folder:',type(out_folder))
                ### print('::::::::::::::::::::::::::::::::::::')
                ### print('Vars for out_folder:',vars(out_folder))
                ### print('::::::::::::::::::::::::::::::::::::')
                ### print('Methods for out_folder:',dir(out_folder))
                ### print('::::::::::::::::::::::::::::::::::::')
                with out_folder.open(filename, 'r') as handler:
                    ### print('::::::::::::::::::::::::::::::::::::')
                    ### print('Type for handler   :',type(handler   ))
                    ### print('::::::::::::::::::::::::::::::::::::')
                    ### print('Vars for handler   :',vars(handler   ))
                    ### print('::::::::::::::::::::::::::::::::::::')
                    ### print('Methods for handler   :',dir(handler   ))
                    ### print('::::::::::::::::::::::::::::::::::::')
            ...
            if 'sknumber' in filename:
                self.logger.info(f"Parsing '{filename}'")
                with out_folder.open(filename, 'r') as handler:
                    data = parser_array_file(handler=handler, usecols=[0, 1, 2])
            ...
            if 'ams' in filename[0:4] and 'qpoints.out' in list_of_files:
                ...
                with out_folder.open('qpoints.out', 'r') as handler:
                    data = parser_array_file(handler=handler)
        ...
        if ams_plot_settings:
            ...
            with out_folder.open('qfile', 'r') as handler:
