...
class UppASDSkyrmionsWorkflow(WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.outline(
                ...
                if_(cls.check_for_plot_average_magnetic_moment)(
                    cls.plot_average_magnetic_moment
                ),
                if_(cls.check_for_plot_average_specific_heat)(
                    cls.plot_average_specific_heat
                ),
                )
    ...
    def combined_for_PD(self):
        ...
        for idx_T,temperature in enumerate(self.inputs.temperatures):
            for idx_B,externel_B in enumerate(self.inputs.external_fields):
                skyrmions_singleplot.append(Image.open('{}/T{}B{}.png'.format(plot_dir,idx_T,idx_B)).crop((200,0,848,640))) #we need to crop the white edges 
